...
DEFAULT_SFX_ASSETS: Sequence[AssetDescriptor] = (
    ...
    AssetDescriptor(
        id="sfx_riser_tension_01",
        name="Riser de Tensión",
        category="riser",
        relative_path="sfx/risers/riser_tension_01.wav",
        duration_seconds=0.65,
        recommended_gain_db=-16.0,
        cooldown_frames=96.0,
        allowed_intents=("question", "emphasis"),
        prohibited_intents=(),
        author="DaVinci Flow",
        license="MIT / Libre de regalías",
        source="Generador procedural de DaVinci Flow",
    ...
    AssetDescriptor(
        id="sfx_glitch_digital_01",
        name="Glitch Digital",
        category="glitch",
        relative_path="sfx/glitches/glitch_digital_01.wav",
    ...
    AssetDescriptor(
        id="sfx_thud_subtle_01",
        name="Impacto Subgrave",
        category="impact",
        relative_path="sfx/impacts/thud_subtle_01.wav",
        duration_seconds=0.50,
        recommended_gain_db=-14.0,
        cooldown_frames=84.0,
        allowed_intents=("statement", "emphasis"),
        prohibited_intents=(),
        author="DaVinci Flow",
        license="MIT / Libre de regalías",
        source="Generador procedural de DaVinci Flow",
    ...
    AssetDescriptor(
        id="sfx_chime_success_01",
        name="Chime Armónico de Éxito",
        category="bell",
        relative_path="sfx/bells/chime_success_01.wav",
