...
> - Nunca se debe pasar de una versión de parche `.9` (ej. de `0.1.9` no se pasa a `0.1.10`). Al alcanzar el límite del parche `.9`, se incrementa el número menor/secundario (ej. pasando a `0.2.0`).
